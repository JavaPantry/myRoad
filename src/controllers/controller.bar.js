...
module.exports = function(RoadMap) {
	...
	RoadMap.controllers.bar = RoadMap.DatasetController.extend({

		dataElementType: RoadMap.elements.Rectangle,
		...
		getStackCount: function(last) {
			...
			var stacked = false;//AVP: scale.options.stacked;
		...
		getRuler: function() {
			...
			var fullSize = 200;//AVP: scale.isHorizontal()? scale.width : scale.height;
			var tickSize = 10; //AVP: fullSize / scale.ticks.length;
			var categorySize = 10; //AVP: tickSize * options.categoryPercentage;
	...
	RoadMap.defaults.horizontalBar = {
		hover: {
			mode: 'label'
		},
	...
	RoadMap.controllers.horizontalBar = RoadMap.controllers.bar.extend({
		/**
		 * @private
		 */
		getValueScaleId: function() {
